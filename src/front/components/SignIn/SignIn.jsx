...
export const SignIn = () => {
    ...
    return (
        ...
        <div className='d-flex justify-content-center'>
            <div className="card sign-in-card mt-5 ms-2 ">
                <div className="card-body">
                    <h2 className="card-title text-center">Sign In</h2>
                    <h6 className="card-subtitle mb-2 sign-in-card-subtitle text-end me-4 pe-2 mb-3">Need an account <Link to="/register">Register</Link></h6>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mx-4">
                            ...
                            <input type="email" name="email" placeholder="email" value={formData.email} onChange={handleChange} className='w-100 border-0 rounded-2 border-1 sign-in-card-border' />
                            <div>
