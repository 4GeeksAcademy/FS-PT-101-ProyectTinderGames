                ...
                <div className='d-flex justify-content-center'>
                    <div className='card reset-card mt-5'>
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2 reset-card-subtitle text-end me-4 pe-2 mb-3">Enter the email address associated <br />
                            ...
                            <div>
                                <form>
                                    <div className="mx-4">
                                        ...
                                        <input type="email" name="email" placeholder="email" value="" className='w-100 border-0 rounded-2 btn-reset-card-border' />
                                        <br />
                                        <br />
                        ...
                        <div className="card-body">
                            ...
                            <form >
                                <div className="mx-4">
                                    ...
                                    <input type="password" name="password" placeholder="password" value="" className='w-100 border-0 rounded-2 btn-reset-card-border' />
                                    <div>
                                        <label htmlFor="basic-url" className="form-label mt-3 mb-0">Enter your new password again</label>
                                    </div>
                                    <div>
                                        <input type="password" name="password" placeholder="password" value="" className="w-100 rounded-2 btn-reset-card-border" />
